...
I work with engineering organizations that want to release faster and with more confidence. The engagements sit at two altitudes, the leadership decisions that set a team up to ship and the hands-on practice that makes shipping safe, and the goal is the same at both: less guesswork in production, more trust in the release process.

<p class="availability">Independent, and currently taking on new engagements.</p>

## Fractional engineering leadership

Engineering leadership without the full-time hire. I take the CTO or Head of Engineering role part-time, setting technical direction, making the architecture and build-versus-buy calls, growing the people, and turning delivery into something the rest of the business can plan around.
...
1. **A short call.** [Half an hour, no charge](https://calendar.app.google/XiivjTTvJAGM9mkE8). You describe what you're trying to ship and where it's stuck.
2. **A written proposal.** Scope, shape, duration, and price on one page. If I don't think I'm the right person, you'll hear it here.
3. **The work.** A fixed monthly fee for ongoing engagements, a fixed price for workshops and defined projects.
4. **A handover.** Whatever I build or decide gets written down and left with your team.
