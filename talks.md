...
I speak regularly on feature flagging, observability, developer experience, and the craft of open standards. Slides and abstracts for most talks live on [Sessionize](https://sessionize.com/simon-schrottner) — recordings linked below where available.
...
- **KubeCon EU 2026** — Amsterdam. *18 Bluetooth Controllers Walk Into a Bar: Observability & Runtime Configuration with CNCF Tools* — with Manuel Timelthaler.
- **Cloud Native Innsbruck 2026** — *Fun with Flags: How OpenFeature Solves Your Feature Flag Headaches.*
...
- **Devoxx Morocco 2025** — Marrakech.
- **JavaCro 2025** — Rovinj.
- **JCON OpenBlend Slovenia 2025** — Portorož.
- **Cloudland 2025**.
